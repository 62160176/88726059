        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <?php 
                        echo '<a href="mynote_confirm_edit.php?number=' . $index_number . '" class="fas fa-save col-md-1 text-center" style="font-size: 2.0em; "></a>'
                    ?> 
                </div>
            </div>
                    ...
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            <div class="card-footer bg-transparent border-success text-center">
                                <a href="mynote_delete.php?number=' . $row['number'] . '" class="fas fa-trash col-md-1 text-center" style="font-size: 2.0em;color: Bule; "></a>
                            </div>   ';
                        }
                        } else {
                        echo "0 results";
