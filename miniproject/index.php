            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <h5 class="col-md-6 text-center">
                        ...
                        <a href="mynote_insert.php" class="fas fa-plus col-md-1 text-center" style="color:blue font-size: 2.5em; "></a>
                </div>
            </div>
                    ...
                    <?php 
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "เรื่อง: " . substr($row["note_header"],0,40) . "<br> Detail: " . substr($row["note_detail"],0,100). "...</div>";
                                echo '<div class="col-md-3 text-center"></div>';
                                echo '<a href="mynote_edit.php?number=' . $row['number'] . '" class="fas fa-edit col-md-1 text-center" style="font-size: 3.0em;"></a>';
                                echo "</div></div>";
                                echo '<!-- Modal -->
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Topic: '.$row["note_header"].'</h5>
                            ...
                            echo '<div class="col-md-6 text-center">No data</div>';
                            echo '<div class="col-md-3"></div>';
                            echo "</div></div>";
                        }
                        $conn->close();
